...
#### Exploit
Place an order of negative quantity

#### Impact
Negative amount of money is subtracted from the user wallet, thus adding to the wallet balance instead of substracting. 
